...
def main():
    # himmelblauBSL = Graphing("srcHimmelblau/himmelblau/varyingBitStringLen.txt", "Himmelblau - Bit String Length")
    # # himmelblau.printGeneration().printAverageFitness().printBestFitness().printDiversity()
    # himmelblauBSL.plotStats()

    # himmelblauLS = Graphing("srcHimmelblau/himmelblau/varyingLambdaSize.txt", "Himmelblau - Lambda Size")
    # # himmelblau.printGeneration().printAverageFitness().printBestFitness().printDiversity()
    # himmelblauLS.plotStats()

    himmelblauBSL = Graphing("srcMaxones/maxones/varyingBitStringLen.txt", "Maxones - Bit String Length")
    # himmelblau.printGeneration().printAverageFitness().printBestFitness().printDiversity()
    himmelblauBSL.plotStats()

    himmelblauLS = Graphing("srcMaxones/maxones/varyingMuSize.txt", "Maxones - Mu Size")
    # himmelblau.printGeneration().printAverageFitness().printBestFitness().printDiversity()
    himmelblauLS.plotStats()
